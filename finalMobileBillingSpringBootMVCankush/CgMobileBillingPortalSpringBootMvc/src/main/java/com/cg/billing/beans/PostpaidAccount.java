...
@Entity
@SequenceGenerator(name="postpaid", initialValue=989670000, allocationSize=100000,sequenceName="postpaidAccountSequence")
public class PostpaidAccount {
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="postpaid")
	private long mobileNo;
	@OneToOne
	private Plan plan;
	@ManyToOne
	private Customer customer;
	@OneToMany(mappedBy="postpaidAccount",cascade=CascadeType.ALL,orphanRemoval=true)
	@MapKey
