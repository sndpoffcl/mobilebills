...
public class Plan {
	@SequenceGenerator(name="plan", initialValue=10001, allocationSize=100000,sequenceName="planAccount")
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="plan")
	private int planID;
